...
{
    internal class PP_StatusConverter : IValueConverter
    {
        public static Dictionary<string, string> Statuses;

        static PP_StatusConverter()
        {
            if (System.Windows.Application.Current.Resources["PP_Statuses_List"] is IEnumerable<KVPair> kVPairs)
            {
